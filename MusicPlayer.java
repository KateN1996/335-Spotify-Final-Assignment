...
public class MusicPlayer extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			BrazilBeatsUI ui = new BrazilBeatsUI(spotify);
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
	...
	static class BrazilBeatsUI {
		...
		BrazilBeatsUI(MediaPlayer spotify) {
...
//					double amount = current.toMillis() /total.toMillis();
//					playbackBar.setValue((int) amount / 172);
//					
//				}
//				
//			});
